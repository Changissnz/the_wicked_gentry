...
If it is stated this world is so orderly by the design of human society, the statement would be a lie or a gross exaggeration of untamperable truths that biological life sits on. Sure, there is order that human beings, with the best of interests at heart, play roles in. But think about how grotesque the envisioned ends for certain overdetermined systems. There is no such thing as a system that can continually be built, block after block stacked on top of each other. Where diversity exemplifies the idea of infinity, systems showcase the greatness of containment. The containment is the limitation of scaling of those systems and the capabilities of the agents operating in those systems. 
